...
namespace Blog.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IPublicacaoRepositorio>().To<PublicacaoRepositorio>();
            kernel.Bind<IComentarioRepositorio>().To<ComentarioRepositorio>();

            kernel.Bind<IUsuarioServico>().To<UsuarioServico>();
            kernel.Bind<IPublicacaoServico>().To<PublicacaoServico>();
            kernel.Bind<IComentarioServico>().To<ComentarioServico>();
        }        
    }
}